...
type MaximaMalpunInvitationEmailProps = {
  name: string;
  ticketUrl: string;
};

const MaximaMalpunInvitationEmail = ({
  name,
  ticketUrl,
}: MaximaMalpunInvitationEmailProps) => {
  return (
    <BaseDesign
...
MaximaMalpunInvitationEmail.PreviewProps = {
  name: "Muhammad Fathan Ridhwan",
  ticketUrl: "https://maximaumn.id/malpun/ticket/details?code=MXM24-randomcode",
} as MaximaMalpunInvitationEmailProps;

export default MaximaMalpunInvitationEmail;
